      ...
      .then((user) => {
        if (user) {
          ...
          userModel
            .create(data)
            .then(() => {
              console.log(requestResponse.berhasil("Berhasil Input Order"));
...
exports.getAllUser = () =>
  new Promise((resolve, reject) => {
    userModel
      .find({})
      .then((user) => {
        console.log(requestResponse.berhasil("berhasil get order"));
    ...
    userModel
      ...
      .then((data) => {
        userModel
          ...
          .then(() => {
            console.log(requestResponse.berhasil("berhasil delete order"));
...
exports.edit = (data, id) =>
  new Promise(async (resolve, reject) => {
    ...
    userModel
      ...
      .then(() => {
        console.log(requestResponse.berhasil("Berhasil Edit order"));
